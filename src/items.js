...
import {Dimensions, StyleSheet, View, ScrollView, TouchableWithoutFeedback, Text, TouchableOpacity} from 'react-native'
...
export default class Items extends Component {
    ...
    render() {
        ...
        const renderedItems = React.Children.map(items, (item, i) => {
            return (
